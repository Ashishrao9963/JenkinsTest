...
import com.epm.exception.NotADefaultBrowserException;
...
public class WebDriverFactory {
	...
	public WebDriver getWebDriver(String browser) {
		...
		case "internetexplorerdriver" ->
			internetExplorerDriver == null ? internetExplorerDriver = new InternetExplorerDriver()
		...
		default -> throw new NotADefaultBrowserException("This is not one of the default browsers");
		};
	}
